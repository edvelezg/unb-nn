...
\begin{figure}[]
	\centering
	\subfloat[\label{fig:bpgt-3.0_damping_test_output} Output Comparison]{	
			\includegraphics[width=0.49\columnwidth]{../bpgt-3.0/damping_test/output.pdf}
	}
	\subfloat[\label{fig:bpgt-3.0_damping_test_output_e} Relative Error]{	
			\includegraphics[width=0.49\columnwidth]{../bpgt-3.0/damping_test/output_e.pdf}
	}
	
	\subfloat[\label{fig:bpgt-3.0_damping_test_final_output} Output Comparison]{	
			\includegraphics[width=0.49\columnwidth]{../bpgt-3.0/damping_test/final_output.pdf}
	}
	\subfloat[\label{fig:bpgt-3.0_damping_test_final_output_e} Relative Error]{	
			\includegraphics[width=0.49\columnwidth]{../bpgt-3.0/damping_test/final_output_e.pdf}
	}
...
\begin{figure}[]
	\centering
		\subfloat[\label{fig:bpgt-3.0_damping_test_output_phi} Output Comparison]{	
				\includegraphics[width=0.49\columnwidth]{../bpgt-3.0/damping_test/output_phi.pdf}
		}
		\subfloat[\label{fig:bpgt-3.0_damping_test_output_phi_e} Relative Error]{	
				\includegraphics[width=0.49\columnwidth]{../bpgt-3.0/damping_test/output_phi_e.pdf}
		}
