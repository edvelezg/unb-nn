...
training accuracy of both algorithms. We chose a simple problem that takes as input $2$ numbers and produces as output their sum. To
generate the sample data we let variables $x$ and $y$ range from $0$ to $10$ and add them in all $121$ possible ways. Thus the network
is trained on a sample of $121$ different sets of inputs and outputs
...
feedforward neural network was trained on $121$ sample points for $10000$ iterations. The data was normalized between $-1$ and $1$ to help the neural network.
