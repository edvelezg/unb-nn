...
In this report we will examine two different algorithms for training feedforward neural networks. One algorithm is the Backpropagation
algorithm and the other is the Root Mean Square (RMS) Minimization algorithm.
