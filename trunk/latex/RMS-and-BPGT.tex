...
with a single processing element. We build data structures in order to represent it and simulate its behavior with a
computer~\cite{skapura}. A neural network can be thought of as a directed graph, where the neurons are nodes, and the synaptic weights
