...
inputs and target outputs to the network. We run the feedforward algorithm to generate the corresponding outputs to the presented inputs in our neural network.
The RMS minimization algorithm consists in taking a pair of inputs and for each. blah
