...
external environment or neighboring neurons that are connected to it. The neuron then aggregates the modulated input and passes that information to an activation function.
